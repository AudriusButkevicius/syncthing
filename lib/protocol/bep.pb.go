...
type Hello struct {
	...
	SharingCode   string `protobuf:"bytes,4,opt,name=sharing_code,json=sharingCode,proto3" json:"sharing_code,omitempty"`
}
...
func (m *Hello) MarshalTo(data []byte) (int, error) {
	...
	if len(m.SharingCode) > 0 {
		data[i] = 0x22
		i++
		i = encodeVarintBep(data, i, uint64(len(m.SharingCode)))
		i += copy(data[i:], m.SharingCode)
	}
	return i, nil
}
...
func (m *Hello) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SharingCode", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SharingCode = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
var fileDescriptorBep = []byte{
	...
	,
}
